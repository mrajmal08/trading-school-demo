...
class CreateDailyProfitRecordsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('daily_profit_records', function (Blueprint $table) {
            $table->id();
            $table->string('uuid');
    ...
    {
        Schema::dropIfExists('daily_profit_records');
    }
}
