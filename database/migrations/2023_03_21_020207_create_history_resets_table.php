...
class CreateHistoryResetsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('history_resets', function (Blueprint $table) {
            $table->id();
            $table->string('uuid');
            ...
            $table->foreign('package_purchase_account_detail_id')->references('id')->on('package_purchase_account_details')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('history_resets');
    }
}
