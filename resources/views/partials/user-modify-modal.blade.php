   ...
   <div class="modal-dialog modal-dialog-centered discount-modal-dialog">
      <div class="modal-content modalContent">
         ...
         <div class="modal-body modalBody">
            <form method="post" id="amount-form" action="{{ route('account.balance.update') }}">
                @csrf()
               <div class="row gx-1">
                ...
                <div class="invoice-details-wrapper mt-4">
                    <!-- <div class="row">
                        ...
                        {{--  <div class="col-md-6">
                            <button class="btn btn-success float-end withdraw">Withdraw</button>
                        </div>  --}}
                    </div> -->
                </div>
                <div class=" modalFooter mt-4">
                     <div class="row text-center">                    <!-- <div class="row">
                        ...
                        <div class="col-md-12">
                         ...
                         {{-- <div class="col-md-6">
                            <button id="proccedToPay" class="payment-btn withdraw" style="background-color: #0B5ED7;">Withdraw</button>
                        </div> --}}
                    </div>
                </div>
            </form>
