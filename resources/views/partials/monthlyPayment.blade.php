<div class="modal ts-modal" id="monthlyPayment{{ $payment->uuid }}" tabindex="-1" area-labelledby="payment-modal">
    <div class="modal-dialog modal-dialog-centered payment-modal-dialog">
       <div class="modal-content modalContent">
          ...
          <div class="modal-body modalBody">
            ...
            <form method="post" id="payment-form card-form" action="{{ route('admin.paymentMonthly') }}" enctype='multipart/form-data'>
                @csrf
                ...
                <input type="hidden" name="monthly_uuid" class="payment-method" value="{{ $payment->uuid }}">
                <div class="row mt-3">
                   <div class="col-sm-12">
                   ...
                   <div class="col-sm-12 registerCheckbox">
                      <label for="isAgreed">
                         ...
                         I Accept Trading School <a href="" class="text-primary">Teams </a> and <a
                            class="text-primary">Refund Policy</a>.
                      </label>
                      <label for="isSubscribed">
                         <input type="checkbox" name="isSubscribed" id="isSubscribed">
                         Save the Credit Card Information for Future Transcitions & Monthly Subscriptions
                      </label>
                   </div>
                </div>
                <div class="row gx-1 mt-3">
                   <div class="col-sm-12">
                      <button type="submit" id="proccedToPay" class="payment-btn .button.pay" data-bs-dismiss="modal"
