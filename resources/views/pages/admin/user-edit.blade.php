          ...
          <div class="row gy-3 mb-24">
            ...
            <div class="col-sm-4">
              ...
              <select name="gender" id="gender" class="select-control" style="width: 100%;">
                ...
                <option value="1" {{ $row->userDetail->gender === 1 ? 'selected' : '' }}>Man</option>
                <option value="2" {{ $row->userDetail->gender === 2 ? 'selected' : '' }}>Woman</option>
                <option value="3" {{ $row->userDetail->gender === 3 ? 'selected' : '' }}>Non-Binary</option>
              </select>
                ...
                <div class="col-sm-4">
                  <div class="file-thumb card bg-dark ms-auto" style="height: 150px; width: 150px">
                    @if (optional($row->userDetail)->picture)
                      <img src="{{ optional($row->userDetail)->picture }}" alt="Profile Image" class="img-thumbnail bg-dark h-100">
                    @else
        ...
        $("#thumbnail").change(function(e) {
          ...
          if (file) {
            ...
            reader.onload = function(event) {
              $(".img-thumbnail").show().attr("src", event.target.result);
            };
