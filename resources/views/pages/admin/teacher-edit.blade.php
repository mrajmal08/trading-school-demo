...
@section('admin.app-content')
  <div class="teachers-page">
    ...
    <div class="row">
      <div class="col-sm-12">
        <form method="post" action="{{ route('teacher.update', $row->id) }}">
          @csrf
            ...
            <div class="col-sm-6">
              ...
              <select name="country" id="country" class="select-control" style="width: 100%;">
                ...
                @foreach ($countryList as $country)
                  <option <?= $country->country_name == $row->country ? 'selected' : '' ?>
                    value="{{ $country->country_name }}" data-id="{{ $country->id }}">{{ $country->country_name }}
                  </option>
                @endforeach
              </select>
            </div>
          ...
          <div class="row gy-3 mb-24">
            <div class="col-sm-6">
              ...
              <input class="form-control input-control" type="text" name="organisation" placeholder="Organisation"
