...
@section('admin.app-content')
    <div>
        ...
        <form method="post" action="{{ route('card-head-title.update',$cardHeadTitle->uuid) }}" enctype='multipart/form-data'>
            @csrf
            ...
            <div class="col-sm-6">
                    ...
                    <input class="form-control input-control" type="text" name="title" value="{{ $cardHeadTitle->title }}">
                    @if($errors->has('title'))
                ...
                <div class="col-sm-6">
                    ...
                    <input class="form-control input-control" type="text" name="type" value="{{ $cardHeadTitle->type }}">
                    @if($errors->has('type'))
