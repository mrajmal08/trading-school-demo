               ...
               <tbody>
                  ...
                  @forelse ($histories as $history)
                     <tr>
                        ...
                        <td scope="row" class="text-end">{{ number_format($history->rule_1_value, 2) }} /
                           {{ number_format($history->rule_1_maximum, 2) }}</td>
                        <td scope="row" class="text-end">${{ number_format($history->rule_2_value, 2) }} /
                           ${{ number_format($history->rule_2_maximum, 2) }}</td>
                        <td scope="row" class="text-end">${{ number_format($history->rule_3_value, 2) }} /
                           ${{ number_format($history->rule_3_maximum, 2) }}</td>
                        <td scope="row"></td>
                        {{-- <td scope="row">
