...
@section('admin.app-content')
   <?php
      ...
      $allTrade = $risk?->allTrade->first();
      $profitTrades = $risk?->profitTrade->first();
      $losingTrades = $risk?->losingTrade->first();
      $tradeRecord = $risk?->tradeRecord !== null ? $risk?->tradeRecord : collect([]);
      $graphHistory = $risk?->graphHistory !== null ? $risk?->graphHistory : collect([]);
      $livePositions = $risk?->tradePosition !== null ? $risk?->tradePosition : collect([]);

      $progress = [
         'trading_day' => $risk?->trading_day !== null ? $risk?->trading_day : 0,
         'minimum_days' => $risk?->minimumDays !== null ? $risk?->minimumDays : 0,
         'net_liq_value' => $risk?->net_liq_value !== null ? $risk?->net_liq_value : 0,
         'sodbalance' => $risk?->sodbalance !== null ? $risk?->sodbalance : 0,
         'account_size' => $risk?->accountSize !== null ? $risk?->accountSize : 0,

         'rule_three_enable' => $risk?->rule3Enabled !== null ? $risk?->rule3Enabled : 'True',
         'rule_two_enable' => $risk?->rule2Enabled !== null ? $risk?->rule2Enabled : 'True',
         'rule_one_enable' => $risk?->rule1Enabled !== null ? $risk?->rule1Enabled : 'True',

         'rule_three_value' => $risk?->rule_3_value !== null ? $risk?->rule_3_value : 0,
         'rule_two_value' => $risk?->rule_2_value !== null ? $risk?->rule_2_value : 0,
         'rule_one_value' => $risk?->rule_1_value !== null ? $risk?->rule_1_value : 0,

         'rule_three_key' => $risk?->rule3Key !== null ? $risk?->rule3Key : 'Max Drawdown (Account Size Floor)',
         'rule_two_key' => $risk?->rule2Key !== null ? $risk?->rule2Key : 'Daily Loss Limit',
         'rule_one_key' => $risk?->rule1Key !== null ? $risk?->rule1Key : 'Number of Contracts',

         'rule_three_maximum' => $risk?->rule_3_maximum !== null ? $risk?->rule_3_maximum : 0,
         'rule_two_maximum' => $risk?->rule_2_maximum !== null ? $risk?->rule_2_maximum : 0,
         'rule_one_maximum' => $risk?->rule_1_maximum !== null ? $risk?->rule_1_maximum : 0,
      ];

      $userDetail = [
         'account_status' => $risk?->account_status,
      ];
   ?>
   <!-- Matrix Page -->
