...
@section('admin.app-content')
    ...
    <div class="row mb-4">
         ...
         <div class="col-sm-6 text-end">
            <a class="btn btn-primary create-btn" href="{{ route('service.create') }}">Create Service</a>
         </div>
      </div>
        <div class="card card-box history-table">
            <div class="cardbox-header">
                <h3 class="cardbox-title">Service List</h3>
                <div class="filter-wrapper">
                    <form action="{{route('service.index')}}" class="filter-form">
            ...
            <div class="table-responsive">
                <table class="table-borderless trade-table table">
                    ...
                    <tbody>
                        @forelse ($serviceList as $value)
                            <tr>
                                <td scope="row">{{ $loop->index+1 }}</td>
                                <td scope="row">{{$value->name}}</td>
                                <td scope="row">
                                    <div class="action-cell">
                                        <a href="{{ route('service.edit', $value->uuid) }}">
