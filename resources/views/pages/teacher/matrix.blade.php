            ...
            <div class="card-box matrix-details-card trade-details-card">
               ...
               <div class="card-body winningTrade">
                  ...
                  <div class="trade_performance__text d-flex">
                     <p class="w-50 px-2 text-end"># of Trades</p>
                     <p class="w-50 px-2 text-start">
                        {{ !empty($profitTrades->numberTrades) ? $profitTrades->numberTrades : 0 }}</p>
                  </div>
                  <div class="trade_performance__text d-flex">
                     <p class="w-50 px-2 text-end"># of Contracts</p>
                     <p class="w-50 px-2 text-start">
                        {{ !empty($profitTrades->numberContracts) ? $profitTrades->numberContracts : 0 }}</p>
                  </div>
                  <div class="trade_performance__text d-flex">
                     <p class="w-50 px-2 text-end">Avg Trading Time</p>
                     <p class="w-50 px-2 text-start">
            ...
            <div class="card-box matrix-details-card trade-details-card">
               ...
               <div class="card-body losingTrades">
                  ...
                  <div class="trade_performance__text d-flex">
                     <p class="w-50 px-2 text-end"># of Trades</p>
                     <p class="w-50 px-2 text-start">
                        {{ !empty($losingTrades->numberTrades) ? $losingTrades->numberTrades : 0 }}</p>
                  </div>
                  <div class="trade_performance__text d-flex">
                     <p class="w-50 px-2 text-end"># of Contracts</p>
                     <p class="w-50 px-2 text-start">
                        {{ !empty($losingTrades->numberContracts) ? $losingTrades->numberContracts : 0 }}</p>
                  </div>
                  <div class="trade_performance__text d-flex">
                     <p class="w-50 px-2 text-end">Avg Trading Time</p>
                     <p class="w-50 px-2 text-start">
               ...
               if (data.allTrades) {
                  ...
                  Object.keys(trades).map((key) => {
                     ...
                     if (key === 'totalPl' || key === 'avgPlTrade') {
                        ...
                        if (key === 'avgTradingTime') {
                           const seconds = trades[key] / 1000;
                           // console.log(moment.duration(-seconds, 'seconds').humanize())
                           tradeList += '<p class="w-50 px-2 text-start">' + moment.duration(-seconds, 'seconds').humanize({}) + '</p>';

                        } else if (key === 'longestTradingTime') {
                           const seconds = trades[key] / 1000;
                           console.log(moment.duration(-seconds, 'seconds').humanize(true))
                           tradeList += '<p class="w-50 px-2 text-start">' + moment.duration(-seconds, 'seconds').humanize({h: 24, d: 7, w: 4, m: 30}) + '</p>';
