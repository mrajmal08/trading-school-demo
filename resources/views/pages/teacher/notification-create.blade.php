...
@section('app-content')
   <div class="teachers-page">
      ...
      <div class="row justify-content-center">
         <div class="col-md-12">
            <form method="post" action="{{ route('teacher.notification.store') }}" enctype='multipart/form-data'>
               @csrf
               <div class="row gy-3 mb-24">
                  <div class="col-sm-6">
                     ...
                     <select name="user[]" id="multiple_user" class="form-control input-control" multiple required style="width: 100%">
