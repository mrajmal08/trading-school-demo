...
@section('app-content')
    ...
    <div class="row mb-4">
         ...
         <div class="col-sm-6 text-end">
            <a class="btn btn-primary create-btn" href="{{ route('teacher.faq.create') }}">Create New</a>
         </div>
      </div>
        <div class="card card-box history-table">
            <div class="cardbox-header">
                <h3 class="cardbox-title">Frequently Asked Questions</h3>
                {{-- <div class="filter-wrapper">
                    <form action="{{route('faq.index')}}" class="filter-form">
                            ...
                            <tr>
                                ...
                                <td scope="row">
                                    <div class="action-cell">
                                        <a href="{{ route('teacher.faq.edit', $value->id) }}">
