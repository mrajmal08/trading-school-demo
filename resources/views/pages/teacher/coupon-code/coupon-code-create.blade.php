...
@section('app-content')
    <div>
        ...
        <form method="post" action="{{ route('teacher.coupon-code.store') }}" enctype='multipart/form-data'>
            @csrf
            <div class="row gy-3 mb-24">
                <div class="col-sm-6">
                    ...
                    <input class="form-control input-control" type="text" name="promotion_name" value="{{ old('promotion_name') }}">
                ...
                <div class="col-sm-6">
                    ...
                    <input class="form-control input-control" type="text" name="amount">
            ...
            <div class="row gy-3 mb-24">
                ...
                <div class="col-sm-6">
                    ...
                    <input class="form-control input-control" type="datetime-local" name="date_range">
                ...
                <div class="col-sm-6">
                    ...
                    <select name="max_use" class="form-control input-control max_use">
                        <option <?= old('max_use') === 'forever' ? 'selected' : '' ?> value="forever">Unlimited</option>
                        <option <?= old('max_use') == 'once' ? 'selected' : '' ?> value="once">Once</option>
                    </select>
                ...
                <div class="col-sm-6 coupon_count_row">
                    ...
                    <input type="number" name="total_number" class="form-control input-control" value="{{ old('total_number') }}">
