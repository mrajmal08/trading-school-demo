...
@section('app-content')
    <div class="history-page">
        <div class="card card-box history-table">
            <div class="cardbox-header">
                ...
                <div class="filter-wrapper">
                    <form action="{{route('teacher.marketDataPurchaseList')}}" class="filter-form">
            ...
            <div class="table-responsive">
                <table class="table-borderless trade-table table">
                    ...
                    <tr>
                        ...
                        <th scope="col" style="text-align: left">CQG Logon</th>
                        ...
                        <tr>
                            ...
                            <td scope="row">
                                <div class="action-cell">
                                   ...
                                   <a href="{{ route('teacher.reProcessMarketData', $marketVal?->uuid) }}">
        ...
        @include('partials.teacher.market-data-log-modal')
    </div>
    ...
    <script>
        $(document).ready(function(){
            $(".modify").on('click',function(){
                ...
                $("#userid").val(userId);
                var actionUrl = "{{ route('teacher.marketDataPurchaselog') }}";
                var request = $.ajax({
                    url: actionUrl,
                    type: "get",
                    data: {userId : userId},
