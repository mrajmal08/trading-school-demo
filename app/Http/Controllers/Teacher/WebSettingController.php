...
class WebSettingController extends Controller
{
    ...
    public function index()
    {
        ...
        if (!empty($row)) {
            return Redirect::route('teacher.web.setting.edit', $row->id);
        } else {
            return Redirect::route('teacher.web.setting.create');
        }
    }
    ...
    {
        return view('pages.teacher.web-setting-create');
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($row) {
            return Redirect::route('teacher.web.setting.edit', $row->id)->with(['success' => 'Setting update successfully']);
        }
    }
    ...
    public function show($id)
    {
        ...
        return view('pages.teacher.web-setting-create', compact('row'));
    }
    ...
    {
        $row = WebSetting::where('id', $id)->first();
        return view('pages.teacher.web-setting-edit', compact('row'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($result) {
            return Redirect::route('teacher.web.setting.edit', $id)->with(['success' => 'Setting update successfully']);
        }
    }
