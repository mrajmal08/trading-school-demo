...
class NotificationController extends Controller
{
    public function create()
    {
        ...
        return view('pages.teacher.notification-create', compact('userList'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($result) {
            return Redirect::route('teacher.notification.create')->with(['success' => 'Notification send successfully']);
        }
    }
}
