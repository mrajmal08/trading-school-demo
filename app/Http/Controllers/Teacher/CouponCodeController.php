...
class CouponCodeController extends Controller
{
    ...
    */
    public function index(Request $request)
    {
        ...
        return view("pages.teacher.coupon-code.coupon-code-list",compact('couponCodeList'));
    }
    ...
    */
    ...
    {
        return view("pages.teacher.coupon-code.coupon-code-create");
    }
    ...
    */
    public function store(Request $request)
    {
        ...
        if ($row) {
            return Redirect::route('teacher.coupon-code.index')->with(['success' => 'Coupon code create successfully']);
        }
    }
    ...
    */
    ...
    {
        return view("pages.teacher.coupon-code.coupon-code-edit",compact('couponCode'));
    }
    ...
    */
    public function update(Request $request, CouponCode $couponCode)
    {
        ...
        if ($row) {
            return Redirect::route('teacher.coupon-code.index')->with(['success' => 'Coupon code update successfully']);
        }
    }
