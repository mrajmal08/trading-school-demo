...
class BlogController extends Controller
{
    ...
    public function index(Request $request){
        ...
        return view('pages.admin.blog-list',compact('blogList'));
    }

    public function create(){
        $tags = Tags::get();
        return view('pages.admin.blog-create',compact('tags'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($row) {
            return Redirect::route('blog.index', $row->id)->with(['success' => 'Blog create successfully']);
        }
    }
    ...
    public function edit($id){
        ...
        return view('pages.admin.blog-edit',compact(['row','tags']));
    }
    ...
    public function update(Request $request, $id){
        ...
        if ($result) {
            return Redirect::route('blog.index', $row->id)->with(['success' => 'Blog update successfully']);
        }
    }
