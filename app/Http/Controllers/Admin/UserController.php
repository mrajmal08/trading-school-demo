...
class UserController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('pages.admin.user-list', compact(['allUser', 'status']));
    }
    ...
    public function edit($id)
    {
        ...
        return view('pages.admin.user-edit', compact(['row', 'countryList']));
    }
    ...
    public function show(User $user, Request $request)
    {
        ...
        return view('pages.admin.matrix', compact(['user', 'profit_target', 'progress', 'tradeRecord', 'livePositions', 'allTrade', 'profitTrades', 'losingTrades', 'graphHistory', 'userDetail']));
