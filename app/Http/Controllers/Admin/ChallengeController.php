...
class ChallengeController extends Controller
{
    public function index(Request $request)
    {
        ...
        ->paginate(10);
        return view('pages.admin.challenges.challenges', ['challenges' => $challenges]);
    }
    ...
    public function create()
    {
        ...
        return view('pages.admin.challenges.challenge_create', ['services' => $services, 'head_titles' => $card_head_titles, 'sub_titles' => $card_sub_titles, 'market_data' => $marketData]);
    }
    ...
    public function store(ChallengePostRequest $request)
    {
        ...
        try {
            ...
            DB::commit();
            return \redirect()->route('admin.challenges')->with(['status' => 'success', 'message' => 'successfully! created challenge record']);
        } catch (\Throwable$th) {
            DB::rollBack();
    ...
    public function show($id)
    {
        ...
        // \dd($challenge);
        return view('pages.admin.challenges.challenge_detail', ['challenge' => $challenge]);
    }
    ...
    public function edit($id)
    {
        ...
        $marketData = MarketData::all();
        return view('pages.admin.challenges.challenge_edit', ['challenge' => $challenge, 'compareMarket' => $marketDataCompara, 'services' => $services, 'head_titles' => $card_head_titles, 'market_data' => $marketData]);
    }
    ...
    public function destroy($id)
    {
        ...
        try {
            ...
            DB::commit();
            return \redirect()->route('admin.challenges')->with(['status' => 'success', 'message' => 'successfully! deleted challenge record']);
        } catch (\Throwable$th) {
            DB::rollBack();
            throw new Exception($th->getMessage());
            // return redirect()->back()->withErrors($th->getMessage(), 'errors')->withInput();
